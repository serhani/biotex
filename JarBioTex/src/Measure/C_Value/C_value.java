...
public class C_value {
    ...
    public static ArrayList<CandidatTerm> computePossibleTerms(ArrayList<String> al_tagged_doc, ArrayList<String> al_Patterns, String lang){
        try{
    ...
    public static HashMap<String, PT_C_value> computePossibleTermsG(ArrayList<String> al_tagged_doc, ArrayList<String> al_Patterns, String lang){
        try{
            initialize(lang, al_Patterns);
